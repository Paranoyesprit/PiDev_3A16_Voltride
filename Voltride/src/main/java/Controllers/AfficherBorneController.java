...
public class AfficherBorneController {
    ...
    private void generatePDF() {
        try {
            ...
            // Replace "Roboto-Regular.ttf" with the actual font file name
            String fontPath = "C:/Users/REGAIEG Mahdi/Desktop/Roboto/Roboto-BoldItalic.ttf";

            // Load the font
            contentStream.setFont(PDType0Font.load(document, new File(fontPath)), 12);
            // Write table headers
            float margin = 50;
            ...
            // Adjust these values based on your column sizes
            ...
            for (borne b : bornes) {
                ...
                contentStream.newLineAtOffset(margin + cellMargin, yPosition - tableHeight - cellMargin);
                contentStream.showText("ID: " + b.getId());
                contentStream.newLineAtOffset(tableWidth / 4, 0);
                contentStream.showText("Emplacement: " + b.getEmplacement());
                contentStream.newLineAtOffset(tableWidth / 4, 0);
                contentStream.showText("Capacité: " + b.getCapacite());
                contentStream.newLineAtOffset(tableWidth / 4, 0);
                contentStream.showText("État: " + b.getEtat());
