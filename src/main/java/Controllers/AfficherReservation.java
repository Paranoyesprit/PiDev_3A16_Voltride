...
public class AfficherReservation {
    ...
    @FXML
    private TableColumn<Evenement, Integer> DispoR;
    ...
    public void initialize() {
        ...
        DispoR.setCellValueFactory(new PropertyValueFactory<>("placesDispo"));
    ...
    public void consulterReservation(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ConsulterEvenementClient.fxml"));
            Parent root = loader.load();
