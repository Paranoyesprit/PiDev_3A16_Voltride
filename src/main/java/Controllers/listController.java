...
public class listController {
    ...
    private void modifyVoiture(Voiture voitureToModify) {
        try {
            ...
            Controller.modifierVoitureController modifierController = loader.getController();
    ...
    private void ajouter() {
        ...
        @FXML
        private void voirStatistique() {
            try {
                // Charger l'interface des statistiques
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/stat.fxml"));
                Parent root = loader.load();
                StatisticsController controller = loader.getController(); // Assurez-vous que le nom du contrôleur est correct
                // Afficher l'interface des statistiques dans une nouvelle fenêtre
                Scene scene = new Scene(root);
                Stage stage = new Stage();
                stage.setScene(scene);
            ...
            showAlert("Erreur", "Une erreur s'est produite lors de l'ouverture de l'interface des statistiques.");
        }
    }
